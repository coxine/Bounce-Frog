OBJS = src/main.c src/common.c src/event.c src/pages/startPage.c src/pages/quitPage.c src/utils/button.c src/utils/image.c src/utils/quit.c src/utils/style.c 
CC = gcc
