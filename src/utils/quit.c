...
QuitPage *InitQuitPage()
{
    ...
    quitpage->kontinue = InitButton(QP_CONTINUE_HEIGHT, QP_CONTINUE_WIDTH, QP_CONTINUE_X, QP_CONTINUE_Y, QP_CONTINUE_IMG, QP_CONTINUE_NAME, QP_CONTINUE_IMG_ON_HOV, &kontinueOnClick);
